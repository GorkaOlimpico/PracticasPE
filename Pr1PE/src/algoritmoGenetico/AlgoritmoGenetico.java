...
public class AlgoritmoGenetico {
	...
	public AlgoritmoGenetico(int tipo, int tam, int max_gen, float p_cruce, float p_mut, float prec) {
		tam_pob = tam;
		num_max_gen = max_gen;
		prob_cruce = p_cruce;
		prob_mut = p_mut;
		...
		poblacion = creaPoblacion(tipo);
	}
	
	public Individuo[] creaPoblacion(int tipo) {
